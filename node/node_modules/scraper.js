...
var alchemy = new AlchemyAPI('27da825640fc907d1957ec6ae95905ed9dae04ae');
...
var init = function(kw) {
  ...
  mkdirp(saveDir + "/images", function(err) { 
      ...
      mkdirp(saveDir + "/coordsdata", function(err) {});
      startScrape();
...
var startScrape = function() {
  console.log("Starting scraper!!!." + searchQuery);
  ...
  stream.on('tweet', function (status) {
    ...
    if (status.entities.media != undefined) {
        ...
        if (imageUrlMap[url] == undefined) {
          ...
          var myArray = myRe.exec(status.text);
          ...
          if (myArray) {
            ...
            //Get location
            alchemy.entities(status.text, {}, function(err, response) {
              if (err) throw err;
