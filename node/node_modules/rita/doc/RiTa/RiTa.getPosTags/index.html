				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Uses the default PosTagger to tag the input with tags from the <a href='../../PennTags.html'>PENN tag set</a></td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiTa.getPosTags(word);<br/>RiTa.getPosTags(wordArr);</pre></td>
						</tr>
