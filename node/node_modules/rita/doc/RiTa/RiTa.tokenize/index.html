					...
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the input</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String OR Regex (in JS)</th><td width='75%'>regex (optional) the pattern to be used for tokenization</td></tr>
							</table></td>
						</tr>
