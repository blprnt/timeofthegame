				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Replaces each substring matching the regular expression with the replacement.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.replaceAll(regex, replaceWith);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the pattern to be matched</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the replacement string</td></tr>
							</table></td>
						</tr>
