				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Split a RiText into an array of sub-RiText and return the new array. <br/>If an empty String ('') is used as the separator, the String is split between each character.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>split()<br/>split(separator);<br/>split(limit);<br/>split(separator, limit);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>(Optional) Specifies the character to use for splitting the String. If omitted, the entire String will be returned. If an empty String ('') is used as the separator, the String is split between each character.</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(Optional) An integer that specifies the number of splits</td></tr>
							</table></td>
						</tr>
